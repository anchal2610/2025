            ...
            <main className="bg-white w-full min-h-screen ">
                  ...
                  <div className="grid md:grid-cols-3 grid-cols-1 md:gap-2 gap-6 md:mx-28 mt-20  md:mt-28 md:mb-16 ">
                        {testimonial.slice(0, 3).map((data, index) => (
                              <div key={index}>
                                    <AnimateOnScroll>
                                          <div className=" p-4 w-[80%] md:w-[90%] h-[100%] border-2 border-yellow-500  shadow-lg mx-auto justify-center items-center mb-4  rounded-xl hover:bg-gray-200 hover:scale-[1.1] duration-200 " >
