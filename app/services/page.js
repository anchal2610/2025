...
export default function Services() {
      return (
            <main className="bg-white w-full min-h-screen ">
                  ...
                  <div className="relative h-[50vh] w-full  md:border-t-2 ">
                        <img
                              src="hero.png"
                              alt="trip main image"
                              priority
                  ...
                  <div className="grid md:grid-cols-3 grid-cols-1 md:gap-2 gap-6 md:mx-28 mt-20  md:mt-28 md:mb-16 ">
                        {services.map((service, index) => (
                              <AnimateOnScroll>
                                    <div className="relative p-4 w-[80%] md:w-[90%]  shadow-lg mx-auto justify-center items-center mb-4  rounded-xl hover:bg-gray-200 hover:scale-[1.1] duration-200 " key={index}>
